...
export default function ToolsSection() {
  ...
  // ---------------------------------------------------------------------
  // TAB 3 — SVG OPTIMIZER CON VISTA PREVIA VISUAL EN TIEMPO REAL
  // ---------------------------------------------------------------------
  ...
  return (
    <section className="section-container" style={{ paddingTop: '3rem', paddingBottom: '5rem' }}>
      ...
      {/* TAB 3: SVG OPTIMIZER CON VISTA PREVIA VISUAL EN TIEMPO REAL ---------------- */}
      {activeTab === 'svg' && (
        <ToolCard icon={Code} title="Optimizador & Limpiador SVG (SVGO)" description={<>Limpia metadata y comprime el código vectorial con vista previa gráfica instantánea.</>}>
